  ...
  return (
    <section className="mentions">
      ...
      <p>
        ...
        https://chrstn67.github.io/ActiviTeen/#/. Christian HUMBERT décline
        toute responsabilité quant à l'utilisation qui pourrait être faite des
        informations et contenus présents sur
        https://chrstn67.github.io/ActiviTeen/#/. Christian HUMBERT s'engage à
        sécuriser au mieux le site https://chrstn67.github.io/ActiviTeen/#/,
        cependant sa responsabilité ne pourra être mise en cause si des données
        indésirables sont importées et installées sur son site à son insu. Des
        espaces interactifs (espace contact) sont à la disposition des
        utilisateurs. Christian HUMBERT se réserve le droit de supprimer, sans
        ...
        Christian HUMBERT se réserve également la possibilité de mettre en cause
      ...
      <p>
        ...
        du site https://chrstn67.github.io/ActiviTeen/#/ dispose d'un droit
      ...
      <p>
        ...
        https://chrstn67.github.io/ActiviTeen/#/ contient des liens hypertextes
        ...
        https://chrstn67.github.io/ActiviTeen/#/.
      </p>

      <p>
        6 - Droit applicable et attribution de juridiction : Tout litige en
        relation avec l'utilisation du site
        https://chrstn67.github.io/ActiviTeen/#/ est soumis au droit français.
