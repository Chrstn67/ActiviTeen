export const activities = [
  {
    ...
    shortDescription:
      "Créer des œuvres éphémères avec ce que la nature nous donne",
    description:
      "Le LandArt est une activité artistique en plein air où les adolescents utilisent des éléments naturels (feuilles, cailloux, branches, etc.) pour créer des œuvres éphémères. Elle stimule la créativité, le sens de l’observation et le respect de la nature.",
    preparation: `
